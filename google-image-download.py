...
class GoogleImageExtractor(object):
    ...
    def __init__(self, search_key = '' ):
        ...
        #for large images
        #self.postfix_of_search_url = '&source=lnms&tbm=isch&sa=X&ei=0eZEVbj3IJG5uATalICQAQ&ved=0CAcQ_AUoAQ&biw=939&bih=591&tbs=isz:lt,islt:xga'# non changable text
        ...
        self.folder_main_dir_prefix = r'/Users/newscred/Desktop/google_crawler'
    ...
    def extract_pic_url(self):
        ...
        tag_list = dom('a.rg_l')
        print 'tag length: ', len(tag_list)
        print 'download per search: ', self.image_dl_per_search
...
if __name__ == '__main__':
    ...
    searchlist_filename = r'/Users/newscred/Desktop/google_crawler/search_keys.txt'
    w.set_num_image_to_dl(60)
